...
plot_out_avg = os.path.join(file_path_dir, "avgbkrgnd__psd__" + str(direction) + "__" + str(incline) + '.png')
save_out_avg = os.path.join(file_path_dir, "avgbkrgnd__psd__" + str(direction) + "__" + str(incline))
...
for file_name in os.listdir(file_path_dir):
    if file_name.endswith(ext):
        ...
        psd_samp, freq_samp = psd(data_in, NFFT=psd_nfft, Fs=sample_rate / 1e6, Fc=center_freq / 1e6)
